pomExtra in Global := {
  <url>github.com/CatalystCode/streaming-facebook</url>
    <licenses>
      <license>
        <name>MIT</name>
    ...
    <scm>
      <connection>scm:git:github.com/CatalystCode/streaming-facebook</connection>
      <developerConnection>scm:git:git@github.com:CatalystCode/streaming-facebook</developerConnection>
      <url>github.com/CatalystCode/streaming-facebook</url>
    </scm>
    <developers>
      <developer>
